...
QBShared.Jobs = {
	...
	police = {
		...
		offDutyPay = false,
		grades = {
			['0'] = { name = 'Tuyển dụng', payment = 50 },
			['1'] = { name = 'Cán bộ', payment = 75 },
			['2'] = { name = 'Trung sĩ', payment = 115 },
			['3'] = { name = 'Trung úy', payment = 150 },
			['4'] = { name = 'Sếp', isboss = true, payment = 200 },
		},
	},
	ambulance = {
		label = 'EMS',
		...
		grades = {
			['0'] = { name = 'Tuyển dụng', payment = 50 },
			['1'] = { name = 'Nhân viên y tế', payment = 75 },
			['2'] = { name = 'Bác sĩ', payment = 100 },
			['3'] = { name = 'Bác sĩ phẫu thuật', payment = 125 },
			['4'] = { name = 'Sếp', isboss = true, payment = 150 },
		},
	},
	--[[realestate = {
		label = 'Real Estate',
	...
	cardealer = {
		...
		grades = {
			['0'] = { name = 'Tuyển dụng', payment = 50 },
			['1'] = { name = 'Doanh số tại showroom', payment = 75 },
			['2'] = { name = 'Doanh số kinh doanh', payment = 100 },
			['3'] = { name = 'Tài chính', payment = 125 },
			['4'] = { name = 'Người quản lý', isboss = true, payment = 150 },
		},
	},
	mechanic = {
		label = 'LS Customs',
		...
		grades = {
			['0'] = { name = 'Tuyển dụng', payment = 50 },
			['1'] = { name = 'Người mới', payment = 75 },
			['2'] = { name = 'Có kinh nghiệm', payment = 100 },
			['3'] = { name = 'Nâng cao', payment = 125 },
			['4'] = { name = 'Người quản lý', isboss = true, payment = 150 },
		},
	},
	--[[mechanic2 = {
